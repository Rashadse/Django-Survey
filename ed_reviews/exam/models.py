...
class Question( models.Model ):
    ...
    def save(self, *args, **kwargs):
        if (self.question_type == Question.SELECT
...
class Response(models.Model):
    ...
    survey = models.ForeignKey(Survey, on_delete=models.DO_NOTHING)
    interviewer = models.CharField('Name of Interviewer', max_length=400, default='')
    interviewee = models.CharField('Name of Interviewee', max_length=400, default='')
    your_email = models.EmailField('Your email', max_length=400, default='')
